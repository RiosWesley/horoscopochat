...
exports.callGemini = functions.https.onCall(async (data, context) => {
    ...
    const requestData = data; // Assert the type
    if (!requestData || !requestData.taskType || !requestData.payload) {
        ...
        throw new functions.https.HttpsError("invalid-argument", "The function must be called with 'taskType' and 'payload' arguments.");
    }
